...
const s_formId = '1FAIpQLSdnTgOXdqJSLK_N67VLFGaY4ihhaxt13nP8hbFlsbIA-yd4VQ';
const s_nameId = '1558431515';
const s_websiteId = '203945743';
const s_textId = '999460502';
const s_moderatedId = '361731509'
const s_pageId = '1838765771';
const s_replyId = '1729765568';
const s_imageId = '1369789134'
const s_spoilerId = '1154705560'
const s_sheetId = '1FN7LQKZJPou2ROLKzSv8UtqyvrNNb6qkbpBmeayDF44';
...
const s_widgetTitle = 'Leave an Entry';
const s_nameFieldLabel = 'Name';
const s_websiteFieldLabel = 'Website';
const s_imageFieldLabel = 'Image';
const s_spoilerFieldLabel = 'Spoiler';
const s_textFieldLabel = '';
const s_submitButtonLabel = 'Submit';
const s_loadingText = 'Loading entries...';
const s_noCommentsText = 'There is currently no entries for this prompt. Be the first to submit one!';
const s_closedCommentsText = 'Submission of entries is temporarily closed';
const s_websiteText = 'Link'; // The links to websites left by users on their comments
const s_replyButtonText = 'Reply'; // The button for replying to someone
const s_replyingText = 'Replying to an entry by'; // The text that displays while the user is typing a reply
...
const v_formHtml = `
    ...
    <div id="c_spoilerWrapper" class="c-inputWrapper">
        <label class="c-label c-spoilerLabel" for="entry.${s_spoilerId}">${s_spoilerFieldLabel}</label>
        <input class="c-input c-spoilerInput" name="entry.${s_spoilerId}" id="entry.${s_spoilerId}" type="checkbox" onclick="previewImg()">
    </div>
    ...
    <p id="c_message">Make sure to read the <a href="./../rules.html">rules</a> before submitting!</p>
`;
